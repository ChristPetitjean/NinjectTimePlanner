...
namespace TimePlannerNinject.ViewModel
{
    ...
    public class InputDayViewModel : ViewModelBase
    {
        ...
        public InputDayViewModel(ATimePlannerDataService service, IMessageboxService messageboxService, params DateTime[] model)
        {
            ...
            this.ExtraHours = extraHoursInputs.Count() == 1 ? extraHoursInputs.First() : 0;
        ...
        /// </summary>
        public RelayCommand CancelCommand => this.cancelCommand ?? (this.cancelCommand = new RelayCommand(this.ExecuteCancelCommand));
        ...
        /// </summary>
        public RelayCommand OkCommand => this.okCommand ?? (this.okCommand = new RelayCommand(this.ExecuteOkCommand));
        ...
        {
            var response = this.messageboxService.ShowMessagebox(
