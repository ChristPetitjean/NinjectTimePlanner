...
namespace TimePlannerNinject.ViewModel
{
    ...
    public class EditWorkPlacesViewModel : ViewModelBase
    {
        ...
        public RelayCommand AddNewWorkplaceCommand
            => this.addNewWorkplaceCommand ?? (this.addNewWorkplaceCommand = new RelayCommand(this.ExecuteAddNewWorkplaceCommand));
        ...
        public RelayCommand<int> DeleteWorkPlaceCommand
            => this.deleteWorkPlaceCommand ?? (this.deleteWorkPlaceCommand = new RelayCommand<int>(this.ExecuteDeleteWorkPlaceCommand));
